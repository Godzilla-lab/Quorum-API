...
[![Tests](https://img.shields.io/badge/tests-1%2C217-brightgreen.svg)](#development)
...
| | |
|---|---|
| **Engine** | Working. 1,217 tests, offline and keyless |
...
npm install
npm run build
npm test          # 1,217 tests, offline, no keys
```
...
later. Three of the 1,217 tests need a real PostgreSQL server and skip without
`QUORUM_PG_URL`.
