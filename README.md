...
[![Tests](https://img.shields.io/badge/tests-1%2C149-brightgreen.svg)](#development)
...
| | |
|---|---|
| **Engine** | Working. 1,149 tests, offline and keyless |
...
npm install
npm run build
npm test          # 1,149 tests, offline, no keys
```
...
later. Three of the 1,149 tests need a real PostgreSQL server and skip without
`QUORUM_PG_URL`.
