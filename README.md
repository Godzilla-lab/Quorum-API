...
[![Tests](https://img.shields.io/badge/tests-1%2C158-brightgreen.svg)](#development)
...
| | |
|---|---|
| **Engine** | Working. 1,158 tests, offline and keyless |
...
npm install
npm run build
npm test          # 1,158 tests, offline, no keys
```
...
later. Three of the 1,158 tests need a real PostgreSQL server and skip without
`QUORUM_PG_URL`.
